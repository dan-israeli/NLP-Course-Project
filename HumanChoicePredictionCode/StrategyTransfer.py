...
original_features_dict = {"EFs": {"FEATURES_PATH": config["SIMULATION_EFs_PATH"], "REVIEW_DIM": 37},
                          "GPT4": {"FEATURES_PATH": "data/GPT4_PCA_36.csv", "REVIEW_DIM": 36},
                          "BERT": {"FEATURES_PATH": "data/BERT_PCA_36.csv", "REVIEW_DIM": 36}}

# the new BERT PCA embeddings (dimensionality of 5, 10, ... 250)
new_features_dict = {f"BERT_PCA_{i}": {"FEATURES_PATH": f"data/BERT_PCA_embeddings/BERT_PCA_{i}.csv", "REVIEW_DIM": i} for i in range(5, 255, 5)}

new_features_dict.update(original_features_dict)

meta_features_map = {"features": new_features_dict,
